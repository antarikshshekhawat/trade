...
# 🚀 MASSIVELY EXPANDED UNIVERSE (350+ Stocks to guarantee 100+ filtered signals)
FALLBACK_UNIVERSE = {
    "largecap": [
        ...
        "HEROMOTOCO", "SRF", "TVSMOTOR", "BPCL", "MCDOWELL-N", "CANBK", "PNB", "BANKBARODA", "YESBANK", "IDFCFIRSTB"
    ],
    "midcap": [
        "POLYCAB", "PERSISTENT", "COFORGE", "MPHASIS", "BHEL", "NHPC", "LUPIN", "INDHOTEL", "SUPREMEIND", "ASTRAL", 
        "CGPOWER", "DIXON", "ESCORTS", "GODREJPROP", "KPITTECH", "MAXHEALTH", "MAZDOCK", "OFSS", "PAGEIND", "PAYTM", 
        "PIIND", "PRESTIGE", "RECLTD", "SAIL", "TATACOMM", "TORNTPOWER", "UBL", "UCOBANK", "VOLTAS", "ZEEL", 
        "APOLLOTYRE", "ASHOKLEY", "BALKRISIND", "BATAINDIA", "BHARATFORG", "BIOCON", "CONCOR", "COROMANDEL", "CROMPTON", 
        "DALBHARAT", "DEEPAKNTR", "FORTIS", "GLENMARK", "GMRINFRA", "GUJGASLTD", "HONAUT", "IGL", "INDIANB", "INDIGOPNTS", 
        "IPCALAB", "JINDALSTEL", "JUBLFOOD", "L&TFH", "LICHSGFIN", "M&MFIN", "MANAPPURAM", "MFSL", "MGL", "MINDTREE", 
        "MRF", "NAM-INDIA", "NAVINFLUOR", "OBEROIRLTY", "PEL", "PETRONET", "PFC", "PFIZER", "PNBHOUSING", "RAMCOCEM", 
        "RELAXO", "SKFINDIA", "STAR", "SUNTV", "SYNGENE", "TATAPOWER", "UNIONBANK", "WHIRLPOOL"
    ],
    "smallcap": [
        ...
        "CHEMPLASTS", "CITYUNION", "CLEAN", "COCHINSHIP", "CREDITACC", "CSBBANK", "CYIENT", "DATAPATTNS", "DELHIVERY", 
        "DEVYANI", "ECLERX", "EIDPARRY", "EQUITASBNK", "ERIS", "EXIDEIND", "FACT", "FINEORG", "GLS", "GNFC", 
        "GRANULES", "GRAPHITE", "GSPL", "HAPPSTMNDS", "HBLPOWER", "HFCL", "HINDCOPPER", "HOMEFIRST", "ROUTE", "CAMS", 
        "LATENTVIEW", "MAPMYINDIA", "EASEMYTRIP", "ZENTEC", "MTARTECH", "SONACOMS", "OLECTRA", "MASTEK", "INTELLECT", 
        "ZENSARTECH", "REDINGTON", "BIRLASOFT", "TATAELXSI", "AFFLE", "AMBER", "KAYNES", "SYRMA", "AVALON", "CYIENTDLM", 
        "IDEA", "SPICEJET", "IRCTC", "BSE", "MCX", "IEX", "RVNL", "IRCON", "RAILTEL", "TITAGARH", "RITES", "HUDCO", 
        "IREDA", "PTC", "NBCC", "SJVN", "NLCINDIA", "SUZLON", "CESC", "JPPOWER", "RPOWER", "RTNINDIA"
    ],
}
